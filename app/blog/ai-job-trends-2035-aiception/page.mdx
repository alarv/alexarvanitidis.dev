export const metadata = {
  title: "I did a deep dive into AI to understand the future of AI itself (Yes, AIception)",
  description:
...
But they *are* taking the boring parts of our jobs — the boilerplate code, the report summaries, the SQL cleaning.
...
LLMs write skeleton code. Humans still design the architecture, fix the edge cases, write the tests, and decide *what* to build.
