export const metadata = {
  title: 'Celebrity traitors UK: a masterclass in deception and TV magic [no spoilers]',
  description:
...
<Cover src="/celebrity-traitors-uk.jpg" alt="Celebrity Traitors UK: Claudia Winkleman in the castle" caption="" />
