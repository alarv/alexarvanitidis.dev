export const metadata = {
  title: "The worst bugs on production - #3 the €300,000 double refund | Alex Arvanitidis's Blog",
  description:
    'For 15 minutes, refunds ran twice. A quick sanity check caught it—after €300k was gone.',
  openGraph: { title: 'The worst bugs on production - #3 the €300,000 double refund', images: ['/well-hidden-bug.jpg'] },
}

export const revalidate = 3600 * 24

# The worst bugs on production - #3 the €300,000 double refund
