...
<Cover src="/well-hidden-bug.jpg" alt="A looping, maze-like pattern symbolizing an infinite crawler" caption="A mislabelled 'next' button quietly sent the crawler back to start." />
