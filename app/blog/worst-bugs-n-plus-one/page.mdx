export const metadata = {
  title: "The worst bugs on production - #1 the N+1 problem | Alex Arvanitidis's Blog",
  description:
    'A small join change turned one request into ~100 queries. The graph looked like a heartbeat.',
  openGraph: { title: 'The worst bugs on production - #1 the N+1 problem', images: ['/well-hidden-bug.jpg'] },
}
